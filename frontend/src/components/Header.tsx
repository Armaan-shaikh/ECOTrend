...
import { Activity, ShieldCheck, Database, RefreshCw, BarChart2, Layers } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({ onRefresh, onOpenAudit, isRefreshing }) => {
  return (
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-eco-muted font-medium">
            Environmental Intelligence & Historical Analytics Platform
          </p>
        </div>
      </div>
